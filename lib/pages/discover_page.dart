...
import 'package:twitch_ui/json/discover_json.dart';
          ...
          Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: NetworkImage(item['img_profile']), fit: BoxFit.cover)),
          ),
          Container(
            width: size.width,
            height: 180,
          ...
          return Column(
            ...
            children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: primary,
                    image: DecorationImage(image: NetworkImage(discover_json_four[index]['img_profile']),fit: BoxFit.cover)
                  ),
                ),
                SizedBox(height: 8,),
